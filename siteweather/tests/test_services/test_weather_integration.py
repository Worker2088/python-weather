...
class TestWeatherIntegration:
    ...
    @responses.activate
    def test_find_location_by_name_success(
        self, openweather_success_data: dict[str, Any]
    ) -> None:
        ...
        responses.add(
            method=responses.GET, url=api_url, json=openweather_success_data, status=200
        )
